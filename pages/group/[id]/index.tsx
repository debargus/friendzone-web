    ...
    return (
        <SEO title={name} description={description} image={display_image}>
            <Layout>
                ...
                />
                <div className="mt-2 flex items-bottom justify-between gap-3">
                    <div className="ml-4 overflow-hidden flex-1 min-w-0">
                        <h1 className="text-slate-700 font-bold text-2xl text-ellipsis overflow-hidden">{name}</h1>
                    ...
                    <div className="flex flex-row items-center -mt-2 gap-2">
                        {isGroupAdmin() ? (
                            <Fragment>
                                ...
                                <Link href={`/post/create?groupId=${id}`}>
                                    <a className="button">
                                        <HiOutlinePlus className="-ml-2" fontSize={20} />
                                        <span className="ml-2">Add Post</span>
                                    </a>
                                </Link>
                                <Link href={`/group/${id}/edit`}>
                            ...
                            <button className="button cursor-not-allowed" disabled>
                                <HiOutlineClock className="-ml-2" fontSize={20} />
                                <span className="ml-2">Join request sent</span>
                            </button>
                        ) : (
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-5">
                        {isLoading ? (
                            ...
                            <EmptyComponent
                                title="No posts here!"
                                description="This group has no posts yet. You can post in this group if you are a member."
                            />
                        )}
                    </div>
                </div>
